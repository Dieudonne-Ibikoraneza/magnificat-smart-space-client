  ...
  return (
    <>
      <AdminPageHeader
        ...
        action={{ label: t("admin.customers.addCustomer"), icon: UserPlus }}
      />
            ...
            <div className="grid w-full min-w-0 grid-cols-2 gap-3 sm:min-w-[320px] sm:flex-1 lg:w-auto lg:flex-none lg:gap-5">
                ...
                >
                  <SelectTrigger className="h-10 w-full min-w-0 border-border bg-transparent text-sm font-medium">
                    <SelectValue className="min-w-0 truncate">
                      {(value) =>
                        value === "active"
                          ? t("stock.customers.statusValue", { status: t("staff.userStatus.ACTIVE") })
                          : value === "inactive"
                            ? t("stock.customers.statusValue", { status: t("staff.userStatus.INACTIVE") })
              ...
              <div className="min-w-0">
                ...
                >
                  <SelectTrigger className="h-10 w-full min-w-0 border-border bg-transparent text-sm font-medium">
                    <SelectValue className="min-w-0 truncate">
                      {(value) => value === "name" ? t("stock.customers.nameAZ") : t("stock.customers.joinedNewest")}
                    </SelectValue>
                  </SelectTrigger>
                  <SelectContent>
              ...
              >
                ...
                <div className="mt-5 grid grid-cols-2 gap-3">
                  <Button
                    ...
                    variant="outline"
                    onClick={() =>
                      router.push("/admin/customers/" + customer.slug)
                    }
                  ...
                  <Button
                    type="button"
                    variant="outline"
                    onClick={() => router.push(`/admin/orders/new?customer=${customer.slug}`)}
