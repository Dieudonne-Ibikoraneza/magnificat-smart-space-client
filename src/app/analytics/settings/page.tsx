...
const AnalyticsSettingsPage = () => {
  ...
  return (
    <div className="mx-auto max-w-300">
      <AnalyticsPageHeader title="Account Settings" subtitle="Manage your profile and account preferences." />
      ...
      {deleteDialogOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-ink/40 p-4 backdrop-blur-sm" role="dialog" aria-modal="true" aria-labelledby="analytics-delete-dialog-title">
          <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl sm:p-8">
            <div className="flex items-start justify-between gap-4">
              <div>
                <h2 id="analytics-delete-dialog-title" className="text-xl font-bold text-ink">Delete account?</h2>
