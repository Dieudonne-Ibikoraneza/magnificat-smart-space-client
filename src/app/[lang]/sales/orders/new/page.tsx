...
const ORDER_DRAFT_KEY = "mss.order-draft.sales";
...
const CreateOrderWizard = () => {
  ...
  return (
    <>
      <SalesDetailHeader
        breadcrumbs={[
          { label: t("sales.newOrder.crumbOverview"), href: "/sales/overview" },
          { label: t("sales.newOrder.crumbOrders"), href: "/sales/orders" },
          { label: t("sales.newOrder.crumbNew") },
        ]}
        title={t("sales.newOrder.title")}
        actions={
          <Button type="button" variant="outline" onClick={() => router.push("/sales/orders")} className="h-11 px-5 text-sm font-bold">
