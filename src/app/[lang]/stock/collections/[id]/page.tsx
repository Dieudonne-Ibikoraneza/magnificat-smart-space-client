...
import { InventoryProductCard } from "@/app/[lang]/stock/inventory/page";
...
export default function StockCollectionDetailsPage({
  ...
  return (
    <>
      <StockDetailHeader
        breadcrumbs={[
          { label: t("stock.collectionDetail.crumbOverview"), href: "/stock/overview" },
          { label: t("stock.collectionDetail.crumbCollections"), href: "/stock/collections" },
