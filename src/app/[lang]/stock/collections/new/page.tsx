...
const StockRegisterCollectionPage = () => {
  ...
  return (
    <>
      <StockDetailHeader
        breadcrumbs={[
          { label: t("stock.newCollection.crumbOverview"), href: "/stock/overview" },
          { label: t("stock.newCollection.crumbCollections"), href: "/stock/collections" },
          { label: t("stock.newCollection.crumbNew") },
        ]}
        title={t("stock.newCollection.title")}
        actions={
          <Button type="button" variant="outline" onClick={() => router.push("/stock/collections")} className="h-11 px-5 text-sm font-bold">
      ...
      >
        ...
        <div className="flex flex-col-reverse items-stretch gap-3 pb-2 sm:flex-row sm:justify-end">
          <Button type="button" variant="outline" onClick={() => router.push("/stock/collections")} className="h-12 px-6 text-sm font-bold">
            {t("stock.newCollection.cancel")}
          </Button>
