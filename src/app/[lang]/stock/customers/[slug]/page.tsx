...
/**
 * Read-only customer profile for stock managers (`GET /users/customers/:id`,
 * which the backend allows for this role): contact details, lifetime spend,
 * and paged order history. Stock can look a customer up and start an order on
 * their behalf, but editing/suspending stays with admin — same layout as the
 * admin and sales profiles, pointed at `/stock/*` routes.
 */
                ...
                <div className="hidden overflow-x-auto md:block">
                  <Table>
                    <TableHeader>
                      <TableRow>
                        {[
                          t("stock.customerDetail.colOrderId"),
                          t("stock.customerDetail.colDate"),
                          t("stock.customerDetail.colAmount"),
                          t("stock.customerDetail.colStatus"),
                          t("stock.customerDetail.colAction"),
                        ].map((head) => (
