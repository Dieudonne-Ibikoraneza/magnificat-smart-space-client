  ...
  return (
    <>
      <SalesDetailHeader
        ...
        actions={
          <Button type="button" variant="outline" onClick={() => router.push("/sales/catalog")} className="h-11 px-5 text-sm font-bold">
            Cancel
          </Button>
        }
      />
      ...
      >
        ...
        <div className="flex flex-col-reverse items-stretch gap-3 pb-2 sm:flex-row sm:justify-end">
          <Button type="button" variant="outline" onClick={() => router.push("/sales/catalog")} className="h-12 px-6 text-sm font-bold">
            Cancel
          </Button>
